...
public class Frame extends JFrame {
    ...
    private final Image imageIcon = new ImageIcon(Main.getPath("/icon.png")).getImage();
    ...
    private void scheduleTimer(String timerName, long delay, long period) {
        ...
        switch (timerName) {
            ...
            case "RoundClear":
                ...
                timerTask = new TimerTask() {
                    int repeatTime = 0;
                    TextLabel[] aryText = { lblRoundBonus, lblRoundBonusNum, lblTimeBonus, lblTimeBonusNum,
                            lblPerfectBonus, lblPerfectBonusNum,
                            lblTotalScore, lblTotalScoreNum };
                    String[] aryString = { "Round Bonus", Integer.toString(roundBonus), "Time Bonus",
                            Integer.toString(timeBonus),
                            "Perfect Bonus", Integer.toString(perfectBonus), "Total Score",
